...
namespace DoanRapphim.Migrations
{
    ...
    [Migration("20210107064802_khoitao")]
            ...
            modelBuilder.Entity("DoanRapphim.Areas.Admin.Models.VeModel", b =>
                {
                    ...
                    b.Property<int?>("PhimModelId")
                        .HasColumnType("int");

                    b.Property<int?>("PhongModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PhimModelId");

                    b.HasIndex("PhongModelId");
            ...
            modelBuilder.Entity("DoanRapphim.Areas.Admin.Models.VeModel", b =>
                {
                    ...
                    b.HasOne("DoanRapphim.Areas.Admin.Models.PhimModel", null)
                        .WithMany("lstVe")
                        .HasForeignKey("PhimModelId");

                    b.HasOne("DoanRapphim.Areas.Admin.Models.PhongModel", null)
                        .WithMany("lstVe")
                        .HasForeignKey("PhongModelId");
